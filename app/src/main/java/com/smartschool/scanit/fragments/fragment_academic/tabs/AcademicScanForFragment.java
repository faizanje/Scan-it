...
import com.smartschool.scanit.databinding.FragmentAcademicScanForBinding;
...
public class AcademicScanForFragment extends Fragment {

    FragmentAcademicScanForBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAcademicScanForBinding.inflate(getLayoutInflater());
        init();
        setListeners();
