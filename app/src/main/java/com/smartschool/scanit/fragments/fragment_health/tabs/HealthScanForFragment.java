...
import com.smartschool.scanit.databinding.FragmentHealthScanForBinding;
...
public class HealthScanForFragment extends Fragment {
    FragmentHealthScanForBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentHealthScanForBinding.inflate(getLayoutInflater());
        init();
        setListeners();
