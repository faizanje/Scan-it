package com.smartschool.scanit.fragments.fragment_health.tabs;
...
import com.smartschool.scanit.databinding.FragmentHealthListBinding;
...
public class HealthListFragment extends Fragment {
    ...
    FragmentHealthListBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentHealthListBinding.inflate(getLayoutInflater());
        ...
        arryList.add(new TraceListModel(getString(R.string.example_name),"6.",getString(R.string.time),"Out"));
        arryList.add(new TraceListModel(getString(R.string.example_name),"7.",getString(R.string.time),"In"));
        arryList.add(new TraceListModel(getString(R.string.example_name),"8.",getString(R.string.time),"Out"));
        arryList.add(new TraceListModel(getString(R.string.example_name),"9.",getString(R.string.time),"In"));
        ...
        binding.btnCollaps.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int view2 =(binding.rvTraceList.getVisibility()==View.VISIBLE)?R.drawable.ic_pur_down_icon:R.drawable.ic_pur_up_icon;
