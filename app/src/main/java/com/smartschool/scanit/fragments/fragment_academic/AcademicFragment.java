package com.smartschool.scanit.fragments.fragment_academic;
...
import com.smartschool.scanit.databinding.FragmentAcademicBinding;
import com.smartschool.scanit.databinding.FragmentAttendanceBinding;
import com.smartschool.scanit.fragments.fragment_academic.tabs.AcademicListFragment;
import com.smartschool.scanit.fragments.fragment_academic.tabs.AcademicScanForFragment;
...
public class AcademicFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAcademicBinding.inflate(getLayoutInflater());
        init();
    ...
    private void init() {
        ...
        fragments = new Fragment[]{new AcademicScanForFragment(), new AcademicListFragment()};
        ...
        binding.tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                if(tab.getPosition() == 0){
                    setTabStyle(R.drawable.bg_rounded_outline_yellow,R.color.blue);
                    binding.pageBg.getBackground().setTint(getContext().getResources().getColor(R.color.white));
                }else{
                    setTabStyle(R.drawable.bg_rounded_outline_red, R.color.blue);
